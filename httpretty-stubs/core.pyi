...
_ResponseBody: TypeAlias = (
    _Body
    | Callable[[HTTPrettyRequest, str, _Headers], tuple[int, _Headers, _Body]]
)
...
class URIMatcher:
    ...
    def get_next_entry(
        self, method: _HTTPMethod, info: URIInfo, request: HTTPrettyRequest
    ) -> Entry: ...
...
class httpretty(HttpBaseClass):
    ...
    def reset(cls) -> None: ...
    @classmethod
    def historify_request(
        cls, headers: str | bytes, body: _Body = "", sock: object | None = None
    ) -> HTTPrettyRequest: ...
    @classmethod
    def register_uri(
        cls,
    ...
    @classmethod
    def enable(
        cls, allow_net_connect: bool = True, verbose: bool = False
    ) -> None: ...
...
class httprettized:
    ...
    verbose: bool
    def __init__(
        self, allow_net_connect: bool = True, verbose: bool = False
    ) -> None: ...
